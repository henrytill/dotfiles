...
(let ((fg           "black")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line                  ((t (:foreground ,status-fg :background ,status-bg :box nil))))
   `(mode-line-active           ((t (:foreground ,status-fg :background ,status-bg :box nil))))
   `(mode-line-inactive         ((t (:foreground ,status-nc-fg :background ,status-nc-bg :box nil))))
